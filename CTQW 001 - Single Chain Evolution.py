...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 22 14:47:46 2023
...
# Building the adjacency matrix for a 4-qubit chain
# Connections between 1 and 2, 2 and 3, 3 and 4,
...
# Choosing the excitation to exist in the 1st node
...
# It's the plots for rho1(t)[1,1] and rho1(t)[2,2] that are wrong
# The matrices are the same with Mathematica,
# but for some reason Python isn't plotting them properly
# The issue will lie in diagonal_elements or in the figure codes below
...
figure.savefig('evolution_00_chain.png',dpi=300)
...
figure.savefig('evolution_11_chain.png',dpi=300)
...
figure.savefig('evolution_22_chain.png',dpi=300)
...
figure.savefig('evolution_33_chain.png',dpi=300)